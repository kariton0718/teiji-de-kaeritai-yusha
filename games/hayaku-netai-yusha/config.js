...
export const STORY = {
  ...
  night: [
    ['すう、すう……', '「もう1冊」の声が、小さな寝息に変わった。くまと、うさぎも夢の中。起こさないように、そっと毛布をかける。', 'sleep', 'night-01'],
    ['今日も、おつかれさま', 'ママと目が合った。「ありがとう」「こちらこそ」声をひそめて、こつん。ポチも足元で丸くなる。', 'familySleep', 'night-02'],
    ['おやすみ、勇者。', '洗い物も、洗濯も、明日の準備もおしまい。やっと自分も布団へ。いちばん大切な人たちの隣で、勇者は目を閉じた。', 'nightEnd', 'night-03'],
  ],
  dawn: [
  ...
  sendoff: [
    ['いってきます！', 'さっきまで起きなかったふたりが、今は笑顔で手を振る。「いってらっしゃい！」朝の大仕事を、家族で乗り越えた。', 'sendoff', 'sendoff-01'],
    ['……今、何時！？', 'ほっとした瞬間、腕時計を見た。「次は自分だ！」ママとポチに見送られて、勇者の最後の一走りがはじまる。', 'rush', 'sendoff-02'],
  ],
  true: [
    ['出社、間に合った。', '入口をくぐった瞬間、肩から力が抜けた。息を整え、曲がったネクタイを直す。今日の最初の冒険は、もうクリアだ。', 'office', 'true-01'],
    ['家族の朝を、乗り切った。', 'スマホに届いた、家族の笑顔。「無事に着いたよ」短い返事を送る。ひとりで乗り越えた朝じゃない。', 'memory', 'true-02'],
    ['今日も、定時で帰ろう。', 'あの「おかえり」と、静かな寝息が待っている。夜も、朝も、毎日が冒険だ。勇者は今日も、自分の席へ向かった。', 'trueEnd', 'true-03'],
  ],
};
